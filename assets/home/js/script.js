/*============================== 
	- HEHEHHEHEHEHEH
	- Template: Wedding 2 braderkuy
	- Author: braderkuy
	- Website: https://braderkuy.xyz
================================= */
...
document.write("     <div class='image-divider fixed-height' style='background-image:url(assets/images/banner/1628952614373.JPG);' data-stellar-background-ratio='0.5' >");
document.write("            <div class='divider-overlay'><\/div>");
document.write("        <div class='alignment'> ");
document.write("             <div class='v-align center-middle'>  ");
document.write("                  <div class='container'>       ");
document.write("                        <div class='row'>");
document.write("                        <div class='col-md-12'>");
document.write("                        <div id='thank-you' class='scale75-onmobile'>");

document.write("                  <div id='thank' class='animation fadeInUp'>Thank<\/div>");
document.write("                  <div id='you' class='animation fadeInUp'>You<\/div>");
document.write("                  <\/div>");
document.write("                   <p class='animation delay1 fadeInUp' style='letter-spacing:1px;'>Copyright 2021, Copyright 2021, Wastaiqbal - <b>Wastaiqbal.info@gmail.com</b><\/p>");
document.write("            <\/div>");
document.write("        <\/div>");
document.write("    <\/div>");
document.write("  <\/div>");
