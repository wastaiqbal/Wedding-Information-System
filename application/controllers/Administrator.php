...
class Administrator extends CI_Controller {
    ...
    public function products(){
        $data['title'] = 'Undangan - Admin Panel';
    ...
    public function add_product(){
        ...
        if($this->form_validation->run() == false){
            ...
            if($upload['result'] == 'success'){
                ...
                $this->session->set_flashdata('upload', "<script>
                    swal({
                    text: 'Undangan berhasil ditambahkan',
                    icon: 'success'
                    });
                    </script>");
                ...
                $this->session->set_flashdata('failed', "<div class='alert alert-danger' role='alert'>
                Gagal menambah undangan, pastikan icon berukuran maksimal 2mb dan berformat png, jpg, jpeg. Silakan ulangi lagi.
              </div>");
                redirect(base_url() . 'administrator/products');
            }
        }
    ...
    public function add_package(){
        $this->form_validation->set_rules('title', 'title', 'required', ['required' => 'Judul wajib diisi']);
        if($this->form_validation->run() == false){
            $data['title'] = 'Tambah Galeri - Admin Panel';
            $this->load->view('templates/header_admin', $data);
            ...
            if($upload['result'] == 'success'){
                ...
                $this->session->set_flashdata('failed', "<div class='alert alert-danger' role='alert'>
                Gagal menambah Foto, pastikan banner berukuran maksimal 2mb, berformat png, jpg, jpeg.
                </div>");
    ...
    public function show_package($id){
        ...
        if($this->form_validation->run() == false){
            ...
            $this->session->set_flashdata('upload', "<script>
                swal({
                text: 'Undangan berhasil ditambah',
                icon: 'success'
                });
                </script>");
    ...
    public function delete_package_data($id, $idP){
        ...
        $this->session->set_flashdata('upload', "<script>
            swal({
            text: 'Undangan berhasil dihapus',
            icon: 'success'
            });
            </script>");
    ...
    // Countdown dan Tamu Kehormatan
    public function promo(){
        $data['title'] = 'Countdown dll - Admin Panel';
    ...
    public function add_promo(){
        ...
        $this->session->set_flashdata('upload', "<script>
            swal({
            text: 'Tamu berhasil dijadikan Tamu Kehormatan',
            icon: 'success'
            });
            </script>");
    ...
    public function delete_promo($id){
        ...
        $this->session->set_flashdata('upload', "<script>
            swal({
            text: 'Tamu untuk Tamu Kehormatan berhasil dihapus',
            icon: 'success'
            });
            </script>");
        redirect(base_url() . 'administrator/promo');
    ...
    public function setting_change_logo2(){
        $data = array();
        $upload = $this->Settings_model->uploadlogo();
        if($upload['result'] == 'success'){
            $this->Settings_model->updateLogo2($upload);
            $this->session->set_flashdata('upload', "<script>
                swal({
            ...
            $this->session->set_flashdata('failed1', "<div class='alert alert-danger' role='alert'>
            Gagal mengubah Foto , pastikan Foto  berukuran maksimal 2mb, berformat png, jpg, jpeg.
            </div>");
            redirect(base_url() . 'administrator/setting/general');
        }
    }

    public function setting_change_logo3(){
        $data = array();
        $upload = $this->Settings_model->uploadlogo();
        if($upload['result'] == 'success'){
            $this->Settings_model->updateLogo3($upload);
            $this->session->set_flashdata('upload', "<script>
                swal({
                text: 'Foto berhasil diubah',
                icon: 'success'
    ...
    public function setting_change_foto_laki(){
        $data = array();
        $upload = $this->Settings_model->uploadlogo();
        if($upload['result'] == 'success'){
            $this->Settings_model->updateLaki($upload);
            $this->session->set_flashdata('upload', "<script>
                swal({
                text: 'Foto berhasil diubah',
                icon: 'success'
            ...
            redirect(base_url() . 'administrator/yahalo');
        }else{
            $this->session->set_flashdata('failed1', "<div class='alert alert-danger' role='alert'>
            Gagal mengubah Foto, pastikan Foto berukuran maksimal 2mb, berformat png, jpg, jpeg.
            </div>");
    ...
    // Semua
    public function yahalo(){
        $data['title'] = 'Pengaturan - Admin Panel';
        $data['couple'] = $this->Settings_model->getCouple();
        $data['couple'] = $this->db->get('couple')->row_array();
        $data['lovestory'] = $this->Settings_model->getLovestory();
        $data['lovestory'] = $this->db->get('lovestory')->row_array();
        $this->load->view('templates/header_admin', $data);
        $this->load->view('administrator/setting_semua', $data);
        $this->load->view('templates/footer_admin');
    }
    public function edit_couple(){
        $this->Settings_model->editCouple();
        $this->session->set_flashdata('upload', "<script>
            swal({
            text: 'Deskripsi singkat berhasil diubah',
            icon: 'success'
    ...
    public function edit_lovestory(){
        $this->Settings_model->editLovestory();
        $this->session->set_flashdata('upload', "<script>
            swal({
            text: 'Love Story singkat berhasil diubah',
            icon: 'success'
            });
            </script>");
        redirect(base_url() . 'administrator/yahalo');
