        ...
        <div class="col-md-9">
            <div class="card shadow">
                <div class="card-header">
                    <h2 class="lead text-dark mb-0">Home Wallpaper</h2>
                </div>
                <div class="card-body">
                   <a href="<?= base_url(); ?>administrator/setting/banner/add" class="btn btn-sm btn-info">Tambah Home Wallpaper</a>
                   <hr>
                   <?php if($banner->num_rows() > 0){ ?>
                   <table class="table table-bordered">
                        <tr>
                            <th>Gambar (Hanya bisa satu gambar)</th>
                            <th>Aksi</th>
                        </tr>
