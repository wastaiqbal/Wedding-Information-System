  ...
  ?>
    ...
    <div id="wrapper">
      ...
      >
        ...
        <li class="nav-item">
          <a class="nav-link" href="<?= base_url(); ?>administrator/gallery">
        ...
        <li class="nav-item">
          <a class="nav-link" href="<?= base_url(); ?>administrator/promo">
            <i class="fas fa-fw fa-fire"></i>
            <span>Honorable Guest </span></a
          >
        </li>

        <li class="nav-item">
          <a class="nav-link" href="<?= base_url(); ?>administrator/yahalo">
            <i class="fas fa-fw fa-cog"></i>
            <span>Pengaturan Dasar</span></a
          >
        </li>
